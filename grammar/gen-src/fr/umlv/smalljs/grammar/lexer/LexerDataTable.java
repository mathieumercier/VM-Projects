...
public class LexerDataTable {
  ...
  private LexerDataTable() {
    ...
    RuleData _while = new RuleData(_whileMain, null, 25, false);
    ...
    RuleData _return = new RuleData(_returnMain, null, 26, false);
    inittextMainAccepts();
    inittextMainTransitions();
    CharRegexTable textMain = new CharRegexTable(2, textMainTransitions, textMainAccepts);
    RuleData text = new RuleData(textMain, null, 27, false);
    ...
    RuleData integer = new RuleData(integerMain, null, 28, false);
    initidMainAccepts();
    initidMainTransitions();
    CharRegexTable idMain = new CharRegexTable(1, idMainTransitions, idMainAccepts);
    RuleData id = new RuleData(idMain, null, 29, false);
